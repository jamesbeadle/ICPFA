...
<div class="mx-auto md:mx-16 flex pt-4 items-center justify-center flex-col">
    <div class="text-center w-full">
        <h1 class="title-font sm:text-4xl text-2xl md:mb-4 mt-4 font-medium text-white">The Mission</h1>
        <div class="flex justify-center">
                <div class="flex border-2 rounded-lg border-gray-800 pl-8 pr-8 md:mt-4 md:p-0 md:pb-8 sm:flex-row flex-col">
                    ...
                    <div class="md:flex-1 md:basis-1/2 flex justify-center items-center">
                        <img class="object-cover object-center rounded-lg px-4" alt="Community Fund" src="mission.jpg" />
                      </div>
