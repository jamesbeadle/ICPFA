<script lang="ts">
    ...
    // When the component is mounted or whenever products change, set activeImages
    onMount(() => {
        activeImages = products.map((_, i) => `front_${i}`);
        console.log(activeImages)
    });

    // Watch for changes in products and update activeImages accordingly
    $: activeImages = products.map((_, i) => `front_${i}`);
</script>
    ...
    {#each products as product, i}
         ...
         <div class="p-4 rounded-lg w-64 mx-auto">
            ...
            <div class="flex justify-between items-center">
                ...
                <!-- Basket Button -->
                <svg class="ml-2" width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
