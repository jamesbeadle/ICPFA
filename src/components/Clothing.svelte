    ...
    {#each paginatedProducts as product, i}
         <div class="p-4 rounded-lg w-64 mx-auto">
            ...
            <div class="flex justify-between items-center">
                ...
                <button class="ml-2 bg-custom-blue hover:bg-custom-blue text-white font-bold py-2 px-4 rounded" on:click={() => showProductModal(product)}>
...
<ProductModal bind:product={activeModalProduct} showModal={!!activeModalProduct} on:close={() => activeModalProduct = null} />
