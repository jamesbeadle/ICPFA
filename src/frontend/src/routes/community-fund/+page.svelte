<script lang="ts">
  ...
  const WALLET_ACCOUNT_ID =
    "66d542934fd0be74eaef2f5542b14832799be9f85d256555927a9760dcf2ac96";
...
<section class="text-white bg-gray-800 body-font">
  <div class="container mx-auto flex pt-4 items-center justify-center flex-col">
    <div class="text-center w-full">
      <h1
        class="title-font sm:text-4xl text-2xl mb-4 mt-4 font-medium text-white"
      >
        The ICPFA Community Fund
      </h1>
      <div class="flex justify-center">
        <div
          class="flex rounded-lg p-8 mt-4 md:p-0 md:pb-8 sm:flex-row flex-col lg:w-2/3"
        >
          <div class="md:text-left text-center md:flex-1 md:basis-3/5 mb-4">
            ...
            {/if}
            <small class="wallet-address break-all"
              >66d542934fd0be74eaef2f5542b14832799be9f85d256555927a9760dcf2ac96</small
            >
          ...
          <div class="md:flex-1 md:basis-2/5">
            <img
              class="w-100 object-cover object-center rounded-lg"
              alt="Community Fund"
  ...
  <div class="container py-10 mx-auto px-8 md:px-4">
    <div class="flex flex-wrap w-full mb-4">
      <div class="lg:w-2/3 mx-auto">
        <h2 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">
          Good Causes
        </h2>
        <p class="leading-relaxed text-base mt-4">
          The ICPFA Community Fund was created to support grassroots footballing
          causes, starting with providing new kits to over 200 junior football
          clubs.
        </p>
        <p class="leading-relaxed text-base mt-4">
          After this the fund will benefit from the proceeds of the OpenFPL
          fantasy football game after its decentralisation sale, with the
          OpenFPL founder committing 25% of his maturity interest to support
          ICPFA charitable causes worldwide.
        </p>
        <p class="leading-relaxed text-base mt-4">
          We are also preparing for the launch of an updated FootballGod
          platform in 2024. The original platform will evolve from a sweepstake
          prediction game into a multi-game platform, introducing a variety of
          new game types, including 'last man standing' contests. All revenue
          generated from the FootballGod platform will be directed into the
          ICPFA Community Fund.
        </p>
      </div>
    </div>
  </div>
