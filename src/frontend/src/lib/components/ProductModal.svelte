        ...
        <div class="thumbnail-row">
          <div class="thumbnail-container">
            <div class="thumbnail-col">
              <div
                class="thumbnail {activeImageType === 'front'
                  ? 'thumbnail-active'
                  : ''}"
                role="button"
                tabindex="0"
              ...
              <div
                class="thumbnail {activeImageType === 'back'
                  ? 'thumbnail-active'
                  : ''}"
                role="button"
                tabindex="0"
              ...
              >
                {#if product?.teamId && product?.teamId > 0}
                  <img
                    src={`shirts/${product?.teamId}_${product?.shirtNumber}.jpg`}
                    alt="Back view"
                    class="w-full h-full object-cover"
                  />
                {:else}
            ...
            <div class="size-col">
              <div class="bg-black text-white">
                ...
                <div class="flex mb-4">
                  {#each sizes as size}
                    <button
                      class="mx-1 px-4 py-2 border border-white {selectedSize ===
                      size
                        ? 'bg-blue-600'
                        : 'bg-black'}"
          ...
          <!-- Add to Cart Button -->
          <button
            class="mt-4 w-full py-2 bg-blue-600 text-white uppercase disabled:bg-gray-400 disabled:text-gray-200"
            disabled>Add to Cart (Coming Soon)</button
          >
        </div>
      </div>
    </div>
